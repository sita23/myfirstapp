...
if (isset($_GET['id'])) {
    ...
    try {
        $request = $client->request("GET", "/api/company/" . $companyId);
        $company = json_decode($request->getBody()->getContents(), true);
    ...
    if (isset($_POST['update'])) {
        try {
            $response = $client->put("/api/company/" . $companyId, [
                'json' => [
                    'name' => $_POST['name'],
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" id="exampleInputPassword1"
                       placeholder="şirket adı" value="<?=$company['name']?>">
            </div>
            <div class="form-group">
                ...
                <input type="text" name="phone_number" class="form-control" id="exampleInputPassword1"
                       placeholder="telefon numarası" value="<?=$company['phone_number']?>">
            </div>
